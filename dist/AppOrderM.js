...
const Home = /*#__PURE__*/(0, _react.lazy)(() => Promise.resolve().then(() => _interopRequireWildcard(require('./components/Home'))));
const CustomerDashboard = /*#__PURE__*/(0, _react.lazy)(() => Promise.resolve().then(() => _interopRequireWildcard(require('./components/Customer/CustomerDashboard'))));
const ProductDashboard = /*#__PURE__*/(0, _react.lazy)(() => Promise.resolve().then(() => _interopRequireWildcard(require('./components/Product/ProductDashboard'))));
const AppOrderM = () => {
