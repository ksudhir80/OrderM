...
exports.default = exports.ProductDashboard = exports.Home = exports.Customer = void 0;
...
const Home = exports.Home = /*#__PURE__*/(0, _react.lazy)(() => Promise.resolve().then(() => _interopRequireWildcard(require('./Home'))));
const Customer = exports.Customer = /*#__PURE__*/(0, _react.lazy)(() => Promise.resolve().then(() => _interopRequireWildcard(require('./Customer/Customer'))));
const ProductDashboard = exports.ProductDashboard = /*#__PURE__*/(0, _react.lazy)(() => Promise.resolve().then(() => _interopRequireWildcard(require('./Product/ProductDashboard'))));
const AppOrderM = () => {
  return /*#__PURE__*/_react.default.createElement(_reactRouterDom.BrowserRouter, null, /*#__PURE__*/_react.default.createElement(_NavigationBar.default, null), /*#__PURE__*/_react.default.createElement(_react.Suspense, {
    ...
    path: "/customer",
    element: /*#__PURE__*/_react.default.createElement(Customer, null)
  }), /*#__PURE__*/_react.default.createElement(_reactRouterDom.Route, {
    path: "/product",
